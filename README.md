...
## About
Hello there, I am a backend developer that, in my free time, mostly works with minecraft. I make plugins not mods and most of them are private, but I do post some here from time to time. I also work with Python, typescript and javascript but I don't post that here.
